...
// Import types from your Redux interfaces
import {
  ICategory as ReduxICategory,
  ISubLabel as ReduxISubLabel,
} from "@/redux/interfaces/settingInterface";

// Types - Use the imported types or create compatible ones
...
const Category = () => {
  ...
  console.log(sub_label, categories);
  ...
  return (
    <div className="min-h-screen bg-white text-black p-4 md:p-6">
      ...
      <div>
        ...
        <p className="text-gray-600">Manage your categories and sub labels</p>
      </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            {selectedTab === "categories" && (
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  className="px-3 py-2 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent"
                >
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                onChange={(e) => {
                  setCurrentPage(1);
                  // You could make this dynamic if needed
                }}
                className="px-3 py-2 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent"
              >
      ...
      <div className="mb-8 flex space-x-4">
        {selectedTab === "categories" ? (
          <button
            ...
            className="px-4 py-2 bg-black text-white rounded-lg font-medium hover:bg-gray-800 transition-colors flex items-center disabled:opacity-50 disabled:cursor-not-allowed"
                          ...
                          <td className="py-3 px-4">
                            <div className="flex space-x-2">
                              <button
                                ...
                                disabled={
                                  categoryActionLoading || initialLoading
                                }
                              >
                        ...
                        <tr key={subLabel._id} className="hover:bg-gray-50">
                          ...
                          <td className="py-3 px-4">
                            <div className="flex space-x-2">
                              <button
                                onClick={() =>
                                  openSubLabelModal("edit", subLabel)
                                }
                                className="p-2 bg-gray-100 text-gray-700 rounded hover:bg-gray-200 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                disabled={
                                  subLabelActionLoading || initialLoading
                                }
                              >
                                <Edit className="w-4 h-4" />
                              </button>
                              <button
                                onClick={() =>
                                  openDeleteModal("sublabel", subLabel)
                                }
                                className="p-2 bg-red-100 text-red-700 rounded hover:bg-red-200 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                disabled={
                                  subLabelActionLoading || initialLoading
          ...
          {totalPages > 1 && (
            <div className="flex items-center justify-between border-t border-gray-200 pt-6">
              <button
                ...
                className="px-4 py-2 bg-white border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
              >
            ...
            <div className="p-6">
              ...
              <div className="flex justify-end space-x-3 mt-8">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-black text-white rounded-lg font-medium hover:bg-gray-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
                >
            ...
            <div className="p-6">
              ...
              <div className="space-y-6">
                      ...
                      sub_label.map((subLabel) => (
                        <div
                          ...
                          className={`p-3 rounded-lg border cursor-pointer transition-all ${
                            categoryFormData.sub_label.includes(subLabel._id)
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200">
                    ...
                    <button
                      ...
                      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors disabled:opacity-50 ${
                        categoryFormData.navmenu ? "bg-black" : "bg-gray-300"
                      }`}
                    >
                      <span
                        className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                          categoryFormData.navmenu
                            ? "translate-x-6"
                            : "translate-x-1"
                        }`}
                      />
                  ...
                  <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200">
                    <div>
                      <p className="font-medium text-black">Category Menu</p>
                      <p className="text-sm text-gray-600">
                    ...
                    <button
                      ...
                      disabled={categoryActionLoading}
                      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors disabled:opacity-50 ${
                        categoryFormData.category_menu
                          ? "bg-black"
                          : "bg-gray-300"
                      }`}
                    >
